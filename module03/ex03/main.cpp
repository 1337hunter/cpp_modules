...
/*   Updated: 2020/09/23 17:01:14 by gbright          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	scav.meleeAttack("Superjet");
	scavcopy.meleeAttack("Superjet");
	voidy = scav;
	voidy.meleeAttack("Superjet");
	scav.takeDamage(100);
	scav.takeDamage(100);
	...
	NinjaTrap	copynin(ninja);
	NinjaTrap	what;

	copynin = what;
	copynin.ninjaShoebox(robot);
